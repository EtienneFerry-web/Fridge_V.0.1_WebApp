    ...
    public function load(ObjectManager $manager): void
    {
        $arrRecettesData = [
            ...
            self::RISOTTO => [
                ...
                'description'  => 'Un risotto crémeux aux champignons parfumé au parmesan, réconfortant et savoureux.',
            ...
            self::TARTE_POMME => [
                ...
                'description'  => 'Une tarte aux pommes dorée avec une pâte brisée maison et des pommes caramélisées.',
                'difficulte'   => 'Moyen',
                'portion'      => 8,
                'tempsPrepa'   => 30,
                'tempsCuisson' => 40,
            ...
            self::CURRY_LEGUMES => [
                ...
                'description'  => 'Un curry végétarien parfumé aux épices, doux et onctueux grâce au lait de coco.',
                'difficulte'   => 'Facile',
                'portion'      => 4,
                'tempsPrepa'   => 20,
                'tempsCuisson' => 25,
            ...
            self::QUICHE_LORRAINE => [
                ...
                'description'  => 'La vraie quiche lorraine avec lardons, crème et gruyère sur une pâte brisée croustillante.',
                'difficulte'   => 'Moyen',
                'portion'      => 6,
                'tempsPrepa'   => 20,
                'tempsCuisson' => 35,
            ...
            self::RATATOUILLE => [
                ...
                'description'  => 'La ratatouille traditionnelle avec ses légumes du soleil mijotés aux herbes de Provence.',
                'difficulte'   => 'Moyen',
                'portion'      => 6,
                'tempsPrepa'   => 30,
                'tempsCuisson' => 45,
            ...
            self::SALADE_NICOISE => [
                ...
                'description'  => 'La salade niçoise authentique avec thon, anchois, olives et légumes frais.',
                'difficulte'   => 'Facile',
                'portion'      => 4,
                'tempsPrepa'   => 20,
                'tempsCuisson' => 10,
            ...
            self::SAUMON_CITRON => [
                ...
                'description'  => 'Des pavés de saumon fondants avec une sauce légère au citron et à l\'aneth.',
                'difficulte'   => 'Facile',
                'portion'      => 4,
                'tempsPrepa'   => 10,
                'tempsCuisson' => 12,
            ...
            self::BOLOGNESE => [
                ...
                'description'  => 'Une sauce bolognaise mijotée longuement avec boeuf haché, tomates et aromates.',
                'difficulte'   => 'Moyen',
                'portion'      => 6,
                'tempsPrepa'   => 15,
                'tempsCuisson' => 90,
            ...
            self::TARTE_CITRON => [
                ...
                'description'  => 'Une tarte au citron acidulée avec une meringue italienne dorée et légère.',
                'difficulte'   => 'Difficile',
                'portion'      => 8,
                'tempsPrepa'   => 45,
                'tempsCuisson' => 25,
