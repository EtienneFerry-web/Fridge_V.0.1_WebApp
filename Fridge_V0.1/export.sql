...
\restrict jNPFpZvO0mMG1fiiVHGnc5pxjGKmlf7TvAlBxGJAey7GfhO2ptQydJUB1l2X08t
...
--
-- Name: categorie; Type: TABLE; Schema: public; Owner: app
--

CREATE TABLE public.categorie (
    id integer NOT NULL,
    categorie_libelle character varying(80) NOT NULL
);


ALTER TABLE public.categorie OWNER TO app;

--
-- Name: categorie_id_seq; Type: SEQUENCE; Schema: public; Owner: app
--
...
--
-- Name: contenir; Type: TABLE; Schema: public; Owner: app
--
...
CREATE TABLE public.contenir (
    ...
    contenir_unite character varying(30) DEFAULT NULL::character varying,
    recette_id integer,
    contenir_est_coche boolean DEFAULT false NOT NULL,
    contenir_libelle_brut character varying(255) DEFAULT NULL::character varying
);


ALTER TABLE public.contenir OWNER TO app;

--
-- Name: contenir_id_seq; Type: SEQUENCE; Schema: public; Owner: app
--

ALTER TABLE public.contenir ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.contenir_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: etape; Type: TABLE; Schema: public; Owner: app
--

CREATE TABLE public.etape (
    id integer NOT NULL,
    etape_numero integer NOT NULL,
    etape_libelle character varying(150) NOT NULL,
...
ALTER TABLE public.etape OWNER TO app;

--
-- Name: etape_id_seq; Type: SEQUENCE; Schema: public; Owner: app
--

ALTER TABLE public.etape ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.etape_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: favori; Type: TABLE; Schema: public; Owner: app
--
...
ALTER TABLE public.favori OWNER TO app;

--
-- Name: favori_id_seq; Type: SEQUENCE; Schema: public; Owner: app
--

ALTER TABLE public.favori ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.favori_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: foyer; Type: TABLE; Schema: public; Owner: app
--

CREATE TABLE public.foyer (
    id integer NOT NULL,
    foyer_nom character varying(100) NOT NULL,
    foyer_nombre_pers integer NOT NULL,
    foyer_date_creation date NOT NULL
);


ALTER TABLE public.foyer OWNER TO app;

--
-- Name: foyer_id_seq; Type: SEQUENCE; Schema: public; Owner: app
--

ALTER TABLE public.foyer ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.foyer_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: ingredient; Type: TABLE; Schema: public; Owner: app
--

CREATE TABLE public.ingredient (
    id integer NOT NULL,
    ingredient_libelle character varying(100) NOT NULL,
    ingredient_type character varying(50) DEFAULT NULL::character varying
);


ALTER TABLE public.ingredient OWNER TO app;

--
-- Name: ingredient_id_seq; Type: SEQUENCE; Schema: public; Owner: app
--
...
--
-- Name: like_recette; Type: TABLE; Schema: public; Owner: app
--

CREATE TABLE public.like_recette (
    id integer NOT NULL,
...
ALTER TABLE public.like_recette OWNER TO app;

--
-- Name: like_recette_id_seq; Type: SEQUENCE; Schema: public; Owner: app
--

ALTER TABLE public.like_recette ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.like_recette_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: liste; Type: TABLE; Schema: public; Owner: app
--
...
ALTER TABLE public.liste OWNER TO app;

--
-- Name: liste_course; Type: TABLE; Schema: public; Owner: app
--

CREATE TABLE public.liste_course (
    id integer NOT NULL,
    liste_libelle character varying(100),
    liste_date_creation timestamp(0) without time zone NOT NULL,
    liste_statut character varying(20) NOT NULL,
    user_id integer
);


ALTER TABLE public.liste_course OWNER TO app;

--
-- Name: liste_course_id_seq; Type: SEQUENCE; Schema: public; Owner: app
--

ALTER TABLE public.liste_course ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.liste_course_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: liste_id_seq; Type: SEQUENCE; Schema: public; Owner: app
--

ALTER TABLE public.liste ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.liste_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: liste_recette; Type: TABLE; Schema: public; Owner: app
--

CREATE TABLE public.liste_recette (
    liste_id integer NOT NULL,
    recette_id integer NOT NULL
);


ALTER TABLE public.liste_recette OWNER TO app;
...
--
-- Name: note_recette; Type: TABLE; Schema: public; Owner: app
--
...
ALTER TABLE public.note_recette OWNER TO app;

--
-- Name: note_recette_id_seq; Type: SEQUENCE; Schema: public; Owner: app
--

ALTER TABLE public.note_recette ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.note_recette_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: planning; Type: TABLE; Schema: public; Owner: app
--

CREATE TABLE public.planning (
    id integer NOT NULL,
    planning_jour character varying(10) NOT NULL,
    planning_moment character varying(20) NOT NULL,
    user_id integer,
    planning_recette_id integer
);


ALTER TABLE public.planning OWNER TO app;

--
-- Name: planning_id_seq; Type: SEQUENCE; Schema: public; Owner: app
--

ALTER TABLE public.planning ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.planning_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: recette; Type: TABLE; Schema: public; Owner: app
--

CREATE TABLE public.recette (
    id integer NOT NULL,
    recette_libelle character varying(150) NOT NULL,
    recette_description text,
    recette_difficulte character varying(20),
    recette_portion integer,
    recette_temps_prepa smallint,
    recette_temps_cuisson smallint,
    recette_photo character varying(255) DEFAULT NULL::character varying,
    recette_statut character varying(20) NOT NULL,
    recette_origine character varying(50) DEFAULT NULL::character varying,
    recette_created_at date NOT NULL,
    created_by integer,
    source_url character varying(500) DEFAULT NULL::character varying
);


ALTER TABLE public.recette OWNER TO app;

--
-- Name: recette_id_seq; Type: SEQUENCE; Schema: public; Owner: app
--

ALTER TABLE public.recette ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
...
--
-- Name: recette_regime; Type: TABLE; Schema: public; Owner: app
--

CREATE TABLE public.recette_regime (
    recette_id integer NOT NULL,
    regime_id integer NOT NULL
);


ALTER TABLE public.recette_regime OWNER TO app;

--
-- Name: regime; Type: TABLE; Schema: public; Owner: app
--

CREATE TABLE public.regime (
    id integer NOT NULL,
    regime_libelle character varying(100) NOT NULL
);


ALTER TABLE public.regime OWNER TO app;

--
-- Name: regime_id_seq; Type: SEQUENCE; Schema: public; Owner: app
--
...
--
-- Name: repas; Type: TABLE; Schema: public; Owner: app
--

CREATE TABLE public.repas (
    id integer NOT NULL,
    repas_date date NOT NULL,
    repas_type character varying(20) NOT NULL,
    foyer_id integer
);


ALTER TABLE public.repas OWNER TO app;

--
-- Name: repas_id_seq; Type: SEQUENCE; Schema: public; Owner: app
--

ALTER TABLE public.repas ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.repas_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: reset_password_request_reset_id_seq; Type: SEQUENCE; Schema: public; Owner: app
--

ALTER TABLE public.reset_password_request ALTER COLUMN reset_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.reset_password_request_reset_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: stocker; Type: TABLE; Schema: public; Owner: app
--
...
CREATE TABLE public.stocker (
    ...
    foyer_id integer,
    ingredient_id integer,
    stocker_unite character varying(20) NOT NULL,
...
ALTER TABLE public.stocker OWNER TO app;

--
-- Name: stocker_id_seq; Type: SEQUENCE; Schema: public; Owner: app
--

ALTER TABLE public.stocker ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.stocker_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public."user" (
    user_id integer NOT NULL,
    user_email character varying(180) NOT NULL,
...
--
-- Name: user_regime; Type: TABLE; Schema: public; Owner: app
--

CREATE TABLE public.user_regime (
    user_id integer NOT NULL,
    regime_id integer NOT NULL
);


ALTER TABLE public.user_regime OWNER TO app;

--
-- Name: user_user_id_seq; Type: SEQUENCE; Schema: public; Owner: app
--
...
--
-- Data for Name: categorie; Type: TABLE DATA; Schema: public; Owner: app
--

COPY public.categorie (id, categorie_libelle) FROM stdin;
41	Entrée
42	Plat principal
43	Dessert
44	Petit-déjeuner
...
COPY public.commentaire (id, contenu, created_at, is_visible, user_id, recette_id) FROM stdin;
\.


--
-- Data for Name: contenir; Type: TABLE DATA; Schema: public; Owner: app
--

COPY public.contenir (id, contenir_quantite, liste_course_id, ingredient_id, contenir_unite, recette_id, contenir_est_coche, contenir_libelle_brut) FROM stdin;
...
--
-- Data for Name: etape; Type: TABLE DATA; Schema: public; Owner: app
--

COPY public.etape (id, etape_numero, etape_libelle, etape_description, etape_duree, recette_id) FROM stdin;
...
--
-- Data for Name: favori; Type: TABLE DATA; Schema: public; Owner: app
--

COPY public.favori (id, favori_date, favori_user_id, favori_recette_id) FROM stdin;
...
--
-- Data for Name: foyer; Type: TABLE DATA; Schema: public; Owner: app
--

COPY public.foyer (id, foyer_nom, foyer_nombre_pers, foyer_date_creation) FROM stdin;
\.


--
-- Data for Name: ingredient; Type: TABLE DATA; Schema: public; Owner: app
--

COPY public.ingredient (id, ingredient_libelle, ingredient_type) FROM stdin;
244	Farine	Épicerie
...
--
-- Data for Name: like_recette; Type: TABLE DATA; Schema: public; Owner: app
--

COPY public.like_recette (id, like_date, like_user_id, like_recette_id) FROM stdin;
...
--
-- Data for Name: liste; Type: TABLE DATA; Schema: public; Owner: app
--

COPY public.liste (id, nom, user_id) FROM stdin;
\.


--
-- Data for Name: liste_course; Type: TABLE DATA; Schema: public; Owner: app
--

COPY public.liste_course (id, liste_libelle, liste_date_creation, liste_statut, user_id) FROM stdin;
\.


--
-- Data for Name: liste_recette; Type: TABLE DATA; Schema: public; Owner: app
--

COPY public.liste_recette (liste_id, recette_id) FROM stdin;
\.
...
--
-- Data for Name: note_recette; Type: TABLE DATA; Schema: public; Owner: app
--

COPY public.note_recette (id, valeur, created_at, user_id, recette_id) FROM stdin;
\.


--
-- Data for Name: planning; Type: TABLE DATA; Schema: public; Owner: app
--

COPY public.planning (id, planning_jour, planning_moment, user_id, planning_recette_id) FROM stdin;
...
--
-- Data for Name: recette; Type: TABLE DATA; Schema: public; Owner: app
--

COPY public.recette (id, recette_libelle, recette_description, recette_difficulte, recette_portion, recette_temps_prepa, recette_temps_cuisson, recette_photo, recette_statut, recette_origine, recette_created_at, created_by, source_url) FROM stdin;
...
--
-- Data for Name: recette_regime; Type: TABLE DATA; Schema: public; Owner: app
--

COPY public.recette_regime (recette_id, regime_id) FROM stdin;
177	41
177	42
178	41
179	41
...
--
-- Data for Name: regime; Type: TABLE DATA; Schema: public; Owner: app
--

COPY public.regime (id, regime_libelle) FROM stdin;
41	Omnivore
42	Végétarien
43	Vegan
44	Sans gluten
...
--
-- Data for Name: repas; Type: TABLE DATA; Schema: public; Owner: app
--

COPY public.repas (id, repas_date, repas_type, foyer_id) FROM stdin;
\.
...
COPY public.reset_password_request (reset_id, selector, hashed_token, requested_at, expires_at, user_id) FROM stdin;
\.


--
-- Data for Name: stocker; Type: TABLE DATA; Schema: public; Owner: app
--

COPY public.stocker (id, stocker_quantite_dispo, foyer_id, ingredient_id, stocker_unite, stocker_seuil, stocker_date_peremption, user_id) FROM stdin;
\.
...
COPY public."user" (user_id, user_email, user_name, user_firstname, user_roles, user_password, user_username, is_verified, user_date_inscription, user_date_suppression) FROM stdin;
...
--
-- Data for Name: user_regime; Type: TABLE DATA; Schema: public; Owner: app
--

COPY public.user_regime (user_id, regime_id) FROM stdin;
54	41
55	41
56	42
56	44
...
--
-- Name: categorie_id_seq; Type: SEQUENCE SET; Schema: public; Owner: app
--

SELECT pg_catalog.setval('public.categorie_id_seq', 45, true);
...
--
-- Name: contenir_id_seq; Type: SEQUENCE SET; Schema: public; Owner: app
--

SELECT pg_catalog.setval('public.contenir_id_seq', 1227, true);


--
-- Name: etape_id_seq; Type: SEQUENCE SET; Schema: public; Owner: app
--

SELECT pg_catalog.setval('public.etape_id_seq', 825, true);


--
-- Name: favori_id_seq; Type: SEQUENCE SET; Schema: public; Owner: app
--

SELECT pg_catalog.setval('public.favori_id_seq', 111, true);


--
-- Name: foyer_id_seq; Type: SEQUENCE SET; Schema: public; Owner: app
--

SELECT pg_catalog.setval('public.foyer_id_seq', 1, false);


--
-- Name: ingredient_id_seq; Type: SEQUENCE SET; Schema: public; Owner: app
--

SELECT pg_catalog.setval('public.ingredient_id_seq', 282, true);


--
-- Name: like_recette_id_seq; Type: SEQUENCE SET; Schema: public; Owner: app
--

SELECT pg_catalog.setval('public.like_recette_id_seq', 200, true);


--
-- Name: liste_course_id_seq; Type: SEQUENCE SET; Schema: public; Owner: app
--

SELECT pg_catalog.setval('public.liste_course_id_seq', 22, true);


--
-- Name: liste_id_seq; Type: SEQUENCE SET; Schema: public; Owner: app
--

SELECT pg_catalog.setval('public.liste_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.messenger_messages_id_seq', 34, true);


--
-- Name: note_recette_id_seq; Type: SEQUENCE SET; Schema: public; Owner: app
--

SELECT pg_catalog.setval('public.note_recette_id_seq', 1, false);


--
-- Name: planning_id_seq; Type: SEQUENCE SET; Schema: public; Owner: app
--

SELECT pg_catalog.setval('public.planning_id_seq', 30, true);


--
-- Name: recette_id_seq; Type: SEQUENCE SET; Schema: public; Owner: app
--

SELECT pg_catalog.setval('public.recette_id_seq', 213, true);


--
-- Name: regime_id_seq; Type: SEQUENCE SET; Schema: public; Owner: app
--

SELECT pg_catalog.setval('public.regime_id_seq', 45, true);


--
-- Name: repas_id_seq; Type: SEQUENCE SET; Schema: public; Owner: app
--

SELECT pg_catalog.setval('public.repas_id_seq', 1, false);


--
-- Name: reset_password_request_reset_id_seq; Type: SEQUENCE SET; Schema: public; Owner: app
--

SELECT pg_catalog.setval('public.reset_password_request_reset_id_seq', 2, true);


--
-- Name: stocker_id_seq; Type: SEQUENCE SET; Schema: public; Owner: app
--

SELECT pg_catalog.setval('public.stocker_id_seq', 6, true);


--
-- Name: user_user_id_seq; Type: SEQUENCE SET; Schema: public; Owner: app
--
...
--
-- Name: categorie categorie_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--
...
--
-- Name: contenir contenir_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--
...
--
-- Name: etape etape_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--
...
--
-- Name: favori favori_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--
...
--
-- Name: foyer foyer_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.foyer
    ADD CONSTRAINT foyer_pkey PRIMARY KEY (id);


--
-- Name: ingredient ingredient_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--
...
--
-- Name: like_recette like_recette_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.like_recette
    ADD CONSTRAINT like_recette_pkey PRIMARY KEY (id);


--
-- Name: liste_course liste_course_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.liste_course
    ADD CONSTRAINT liste_course_pkey PRIMARY KEY (id);


--
-- Name: liste liste_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--
...
--
-- Name: liste_recette liste_recette_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.liste_recette
...
--
-- Name: note_recette note_recette_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--
...
--
-- Name: planning planning_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--
...
--
-- Name: recette recette_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--
...
--
-- Name: recette_regime recette_regime_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.recette_regime
    ADD CONSTRAINT recette_regime_pkey PRIMARY KEY (recette_id, regime_id);


--
-- Name: regime regime_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--
...
--
-- Name: repas repas_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--
...
--
-- Name: stocker stocker_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--
...
--
-- Name: user_regime user_regime_pkey; Type: CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.user_regime
    ADD CONSTRAINT user_regime_pkey PRIMARY KEY (user_id, regime_id);


--
-- Name: idx_1a3629b32aa58f11; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_1a3629b32aa58f11 ON public.like_recette USING btree (like_recette_id);


--
-- Name: idx_1a3629b3f4e399b6; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_1a3629b3f4e399b6 ON public.like_recette USING btree (like_user_id);


--
-- Name: idx_27ef1a82a76ed395; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_27ef1a82a76ed395 ON public.liste_course USING btree (user_id);


--
-- Name: idx_285f75dd89312fe9; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_285f75dd89312fe9 ON public.etape USING btree (recette_id);


--
-- Name: idx_3c914dfd4680fcb; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_3c914dfd4680fcb ON public.contenir USING btree (liste_course_id);


--
-- Name: idx_3c914dfd89312fe9; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_3c914dfd89312fe9 ON public.contenir USING btree (recette_id);


--
-- Name: idx_3c914dfd933fe08c; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_3c914dfd933fe08c ON public.contenir USING btree (ingredient_id);


--
-- Name: idx_49bb6390de12ab56; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_49bb6390de12ab56 ON public.recette USING btree (created_by);


--
-- Name: idx_67f068bc89312fe9; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_67f068bc89312fe9 ON public.commentaire USING btree (recette_id);


--
-- Name: idx_67f068bca76ed395; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_67f068bca76ed395 ON public.commentaire USING btree (user_id);
...
--
-- Name: idx_a8d351b32b919a58; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_a8d351b32b919a58 ON public.repas USING btree (foyer_id);


--
-- Name: idx_ad495d2b919a58; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_ad495d2b919a58 ON public.stocker USING btree (foyer_id);


--
-- Name: idx_ad495d933fe08c; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_ad495d933fe08c ON public.stocker USING btree (ingredient_id);


--
-- Name: idx_ad495da76ed395; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_ad495da76ed395 ON public.stocker USING btree (user_id);


--
-- Name: idx_b316888535e7d534; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_b316888535e7d534 ON public.recette_regime USING btree (regime_id);


--
-- Name: idx_b316888589312fe9; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_b316888589312fe9 ON public.recette_regime USING btree (recette_id);


--
-- Name: idx_c81da70a89312fe9; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_c81da70a89312fe9 ON public.note_recette USING btree (recette_id);


--
-- Name: idx_c81da70aa76ed395; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_c81da70aa76ed395 ON public.note_recette USING btree (user_id);


--
-- Name: idx_cfd4514135e7d534; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_cfd4514135e7d534 ON public.user_regime USING btree (regime_id);


--
-- Name: idx_cfd45141a76ed395; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_cfd45141a76ed395 ON public.user_regime USING btree (user_id);


--
-- Name: idx_d499bff610902e89; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_d499bff610902e89 ON public.planning USING btree (planning_recette_id);


--
-- Name: idx_d499bff6a76ed395; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_d499bff6a76ed395 ON public.planning USING btree (user_id);


--
-- Name: idx_ef85a2cc9a56c907; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_ef85a2cc9a56c907 ON public.favori USING btree (favori_recette_id);


--
-- Name: idx_ef85a2cccae277b2; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_ef85a2cccae277b2 ON public.favori USING btree (favori_user_id);


--
-- Name: idx_f881fbc189312fe9; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_f881fbc189312fe9 ON public.liste_recette USING btree (recette_id);


--
-- Name: idx_f881fbc1e85441d8; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_f881fbc1e85441d8 ON public.liste_recette USING btree (liste_id);


--
-- Name: idx_fcf22af4a76ed395; Type: INDEX; Schema: public; Owner: app
--

CREATE INDEX idx_fcf22af4a76ed395 ON public.liste USING btree (user_id);


--
-- Name: uniq_8d93d64918d3e277; Type: INDEX; Schema: public; Owner: app
--

CREATE UNIQUE INDEX uniq_8d93d64918d3e277 ON public."user" USING btree (user_username);


--
-- Name: uniq_c81da70aa76ed39589312fe9; Type: INDEX; Schema: public; Owner: app
--

CREATE UNIQUE INDEX uniq_c81da70aa76ed39589312fe9 ON public.note_recette USING btree (user_id, recette_id);
...
CREATE UNIQUE INDEX uniq_identifier_email ON public."user" USING btree (user_email);


--
-- Name: like_recette fk_1a3629b32aa58f11; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.like_recette
    ADD CONSTRAINT fk_1a3629b32aa58f11 FOREIGN KEY (like_recette_id) REFERENCES public.recette(id);


--
-- Name: like_recette fk_1a3629b3f4e399b6; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.like_recette
    ADD CONSTRAINT fk_1a3629b3f4e399b6 FOREIGN KEY (like_user_id) REFERENCES public."user"(user_id);


--
-- Name: liste_course fk_27ef1a82a76ed395; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.liste_course
    ADD CONSTRAINT fk_27ef1a82a76ed395 FOREIGN KEY (user_id) REFERENCES public."user"(user_id);


--
-- Name: etape fk_285f75dd89312fe9; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.etape
    ADD CONSTRAINT fk_285f75dd89312fe9 FOREIGN KEY (recette_id) REFERENCES public.recette(id);


--
-- Name: contenir fk_3c914dfd4680fcb; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.contenir
    ADD CONSTRAINT fk_3c914dfd4680fcb FOREIGN KEY (liste_course_id) REFERENCES public.liste_course(id);


--
-- Name: contenir fk_3c914dfd89312fe9; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.contenir
    ADD CONSTRAINT fk_3c914dfd89312fe9 FOREIGN KEY (recette_id) REFERENCES public.recette(id);


--
-- Name: contenir fk_3c914dfd933fe08c; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.contenir
    ADD CONSTRAINT fk_3c914dfd933fe08c FOREIGN KEY (ingredient_id) REFERENCES public.ingredient(id);


--
-- Name: recette fk_49bb6390de12ab56; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.recette
    ADD CONSTRAINT fk_49bb6390de12ab56 FOREIGN KEY (created_by) REFERENCES public."user"(user_id);


--
-- Name: commentaire fk_67f068bc89312fe9; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.commentaire
    ADD CONSTRAINT fk_67f068bc89312fe9 FOREIGN KEY (recette_id) REFERENCES public.recette(id);


--
-- Name: commentaire fk_67f068bca76ed395; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.commentaire
    ADD CONSTRAINT fk_67f068bca76ed395 FOREIGN KEY (user_id) REFERENCES public."user"(user_id);
...
ALTER TABLE ONLY public.reset_password_request
    ADD CONSTRAINT fk_7ce748aa76ed395 FOREIGN KEY (user_id) REFERENCES public."user"(user_id);


--
-- Name: repas fk_a8d351b32b919a58; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.repas
    ADD CONSTRAINT fk_a8d351b32b919a58 FOREIGN KEY (foyer_id) REFERENCES public.foyer(id);


--
-- Name: stocker fk_ad495d2b919a58; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.stocker
    ADD CONSTRAINT fk_ad495d2b919a58 FOREIGN KEY (foyer_id) REFERENCES public.foyer(id);


--
-- Name: stocker fk_ad495d933fe08c; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.stocker
    ADD CONSTRAINT fk_ad495d933fe08c FOREIGN KEY (ingredient_id) REFERENCES public.ingredient(id);


--
-- Name: stocker fk_ad495da76ed395; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.stocker
    ADD CONSTRAINT fk_ad495da76ed395 FOREIGN KEY (user_id) REFERENCES public."user"(user_id);


--
-- Name: recette_regime fk_b316888535e7d534; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.recette_regime
    ADD CONSTRAINT fk_b316888535e7d534 FOREIGN KEY (regime_id) REFERENCES public.regime(id) ON DELETE CASCADE;


--
-- Name: recette_regime fk_b316888589312fe9; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.recette_regime
    ADD CONSTRAINT fk_b316888589312fe9 FOREIGN KEY (recette_id) REFERENCES public.recette(id) ON DELETE CASCADE;


--
-- Name: note_recette fk_c81da70a89312fe9; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.note_recette
    ADD CONSTRAINT fk_c81da70a89312fe9 FOREIGN KEY (recette_id) REFERENCES public.recette(id);


--
-- Name: note_recette fk_c81da70aa76ed395; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.note_recette
    ADD CONSTRAINT fk_c81da70aa76ed395 FOREIGN KEY (user_id) REFERENCES public."user"(user_id);


--
-- Name: user_regime fk_cfd4514135e7d534; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.user_regime
    ADD CONSTRAINT fk_cfd4514135e7d534 FOREIGN KEY (regime_id) REFERENCES public.regime(id);


--
-- Name: user_regime fk_cfd45141a76ed395; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.user_regime
    ADD CONSTRAINT fk_cfd45141a76ed395 FOREIGN KEY (user_id) REFERENCES public."user"(user_id);


--
-- Name: planning fk_d499bff610902e89; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.planning
    ADD CONSTRAINT fk_d499bff610902e89 FOREIGN KEY (planning_recette_id) REFERENCES public.recette(id);


--
-- Name: planning fk_d499bff6a76ed395; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.planning
    ADD CONSTRAINT fk_d499bff6a76ed395 FOREIGN KEY (user_id) REFERENCES public."user"(user_id);


--
-- Name: favori fk_ef85a2cc9a56c907; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.favori
    ADD CONSTRAINT fk_ef85a2cc9a56c907 FOREIGN KEY (favori_recette_id) REFERENCES public.recette(id);


--
-- Name: favori fk_ef85a2cccae277b2; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.favori
    ADD CONSTRAINT fk_ef85a2cccae277b2 FOREIGN KEY (favori_user_id) REFERENCES public."user"(user_id);


--
-- Name: liste_recette fk_f881fbc189312fe9; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.liste_recette
    ADD CONSTRAINT fk_f881fbc189312fe9 FOREIGN KEY (recette_id) REFERENCES public.recette(id) ON DELETE CASCADE;


--
-- Name: liste_recette fk_f881fbc1e85441d8; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.liste_recette
    ADD CONSTRAINT fk_f881fbc1e85441d8 FOREIGN KEY (liste_id) REFERENCES public.liste(id) ON DELETE CASCADE;


--
-- Name: liste fk_fcf22af4a76ed395; Type: FK CONSTRAINT; Schema: public; Owner: app
--

ALTER TABLE ONLY public.liste
    ADD CONSTRAINT fk_fcf22af4a76ed395 FOREIGN KEY (user_id) REFERENCES public."user"(user_id);
...
\unrestrict jNPFpZvO0mMG1fiiVHGnc5pxjGKmlf7TvAlBxGJAey7GfhO2ptQydJUB1l2X08t
