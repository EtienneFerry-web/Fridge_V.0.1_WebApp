...
import { usePlanningAPI } from '../hooks/usePlanningAPI.js';
import { useNativeDragAndDrop } from '../hooks/useNativeDragAndDrop.js';
const PlanningContext = /*#__PURE__*/createContext();
...
export const PlanningProvider = ({
    ...
    try {
      ...
      if (!data.success) {
        ...
        dispatch({
          ...
          payload: {
            sourceJour: destJour,
            sourceMoment: destMoment,
            destJour: sourceJour,
            destMoment: sourceMoment,
            item
          }
        });
      }
  ...
  return /*#__PURE__*/React.createElement(PlanningContext.Provider, {
    value: {
      state,
      dispatch,
      handleAddRecipe,
